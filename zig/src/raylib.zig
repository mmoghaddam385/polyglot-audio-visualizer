...
pub const __declspec = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):405:9
pub const _cdecl = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):406:9
pub const __cdecl = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):407:9
pub const _stdcall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):408:9
pub const __stdcall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):409:9
pub const _fastcall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):410:9
pub const __fastcall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):411:9
pub const _thiscall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):412:9
pub const __thiscall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):413:9
pub const _pascal = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):414:9
pub const __pascal = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):415:9
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // C:\ProgramData\chocolatey\lib\zig\tools\zig-windows-x86_64-0.10.0\lib\include/stdarg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // C:\ProgramData\chocolatey\lib\zig\tools\zig-windows-x86_64-0.10.0\lib\include/stdarg.h:18:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // C:\ProgramData\chocolatey\lib\zig\tools\zig-windows-x86_64-0.10.0\lib\include/stdarg.h:19:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // C:\ProgramData\chocolatey\lib\zig\tools\zig-windows-x86_64-0.10.0\lib\include/stdarg.h:24:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // C:\ProgramData\chocolatey\lib\zig\tools\zig-windows-x86_64-0.10.0\lib\include/stdarg.h:27:9
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // ../../raylib/src/raylib.h:119:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // ../../raylib/src/raylib.h:122:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // ../../raylib/src/raylib.h:125:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // ../../raylib/src/raylib.h:128:13
